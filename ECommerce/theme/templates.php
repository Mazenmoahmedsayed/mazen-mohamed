...
<body style="background-color:white" onload="totalprice()" >
  ...
  <header id="header"><!--header-->
          ...
          <div class="col-sm-6">
            <div class="contactinfo">
              <ul class="nav nav-pills">
                <li><a href="#"><i class="fa fa-phone"></i> +201xxxxxxxxx</a></li>
                <li><a href="#"><i class="fa fa-envelope"></i> Support@dealtime.com</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-6">
          ...
          <div class="col-sm-9">
            ...
            <div class="mainmenu pull-left">
              <ul class="nav navbar-nav collapse navbar-collapse">
                ...
                <li class="dropdown"><a href="#">Shop Category<i class="fa fa-angle-down"></i></a>
    ...
    <div class="footer-widget">
      <div class="container">
        <div class="row">
          <div class="col-sm-3">
            <div class="single-widget">
              ...
              <ul class="nav nav-pills nav-stacked">
                ...
                <li><a href="http://localhost/ECommerce/index.php?q=contact">Contact Us</a></li>
                <li><a href="http://localhost/ECommerce/index.php?q=profile">Order Status</a></li>
          ...
          <div class="col-sm-3">
            <div class="single-widget">
              <h2>About Deal-Time</h2>
              <ul class="nav nav-pills nav-stacked">
                <li><a href="http://localhost/ECommerce/index.php?q=contact">Company Information</a></li>
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="row">
          <p class="pull-left">Modified by <span><a href="#">Modern-Academy</a></span></p>
          <p class="pull-right">Designed by <span><a href="#">Modern-Academy</a></span></p>
        </div>
      </div>
    </div>
